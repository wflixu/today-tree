...
class ProxiedInput extends React.Component<IPersistentInputPropsInternal> {
	...
	public render() {
		// I'm not confident in whether FOUC will or will not happen so I'm applying the style related props to placeholder as well
	...
	public componentDidMount() {
		...
		if (this.placeholderInputRef.current) {
	...
	public componentWillUnmount() {
		...
		if(parent && this.placeholderInputRef.current){
