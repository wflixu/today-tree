...
class PromisedFS {
    ...
    public writeFile = (path: string, data?: any) => new Promise<void>((res, rej) => {
    ...
    public mkdir = (path: string, mode?) => new Promise<void>((res, rej) => {
    ...
    public mv = (source: string, dest: string) => new Promise<void>((res, rej) => {
...
export async function initFS(mountPoint: string) {
    ...
    const loadFS = () => new Promise<FileSystem>((res, rej) => {
